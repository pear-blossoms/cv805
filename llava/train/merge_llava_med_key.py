...
base_path = '/vast/users/xiaodan/haokunlin/Continual_LLaVA/llava/output/prompt-key/'
save_path = os.path.join(base_path, 'slake-merged-key.pth')

path1 = os.path.join(base_path, 'slake_ct.pth')
path2 = os.path.join(base_path, 'slake_mri.pth')
path3 = os.path.join(base_path, 'slake_xray.pth')
