...
def parse_args():
    ...
    parser.add_argument('--dir', type=str, default="./playground/data/eval/chartqa")
...
if __name__ == '__main__':
    ...
    # test_split = os.path.join(args.dir, 'chartqa_val.jsonl')
    test_split = os.path.join(args.dir, '{}.jsonl'.format(args.split))
