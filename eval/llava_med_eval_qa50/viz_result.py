...
model_dir_suffixes = [
    "llava-v1.5-7b",                     # Baseline model
    "llava-med_CT",                      # After learning CT
    "llava-med_CT_CXR",                  # After learning CXR
    "llava-med_CT_CXR_Histopathology",   # After learning Histo
    "llava-med_CT_CXR_Histopathology_MRI" # After learning MRI
]
...
categories_to_plot = ["overall", "ct_scan", "chest_xray", "histology", "mri"]
# Labels for categories (used in the legend)
category_labels = {
    "overall": "Overall",
    "ct_scan": "CT Task",
    "chest_xray": "CXR Task",
    "histology": "Histo Task",
    "mri": "MRI Task"
}
...
plot_save_dir = "./evaluation_plots_by_task"
